    ...
    : myConfig(c), myW(w), fallBack(0), loadedSuccessfull(0), myState(GT_STYLE_UNDEFINED)
{
    ...
    smallBoardFontSize = "10";
    bigBoardFontSize = "18";
    humanPlayerButtonFontSize = "10";
    betValueFontSize = "11";
    tabBarPaddingTop = "2";
...
void GameTableStyleReader::readStyleFile(QString file)
{
    ...
    if(doc.RootElement()) {
        ...
        if(CardDeckElement) {
            ...
            PokerTrainingStyleFileVersion.clear();
            ...
            BetRaiseHalfPotButtonHover.clear();
            BetRaiseHalfPotButtonChecked.clear();
            BetRaiseHalfPotButtonCheckedHover.clear();

            BetRaiseTwoThirdPotButtonHover.clear();
            BetRaiseTwoThirdPotButtonChecked.clear();
            BetRaiseTwoThirdPotButtonCheckedHover.clear();

            BetRaisePotButtonHover.clear();
            BetRaisePotButtonChecked.clear();
            BetRaisePotButtonCheckedHover.clear();
